...
class BackendManager {
    ...
    async startDevelopmentBackend() {
        const backendPath = this.getBackendPath();
        const pythonCmd = process.platform === 'win32' ? 'python' : 'python3';
        console.log(`Starting development backend at ${backendPath}`);
        this.process = (0, child_process_1.spawn)(pythonCmd, ['-m', 'uvicorn', 'app.main:app', '--host', '0.0.0.0', '--port', '8000', '--reload'], {
            cwd: backendPath,
            env: {
                ...process.env,
                PYTHONUNBUFFERED: '1'
    ...
    async startProductionBackend() {
        ...
        this.process = (0, child_process_1.spawn)(backendPath, [], {
    ...
    async waitForBackend(maxWaitMs = 30000) {
...
const backend_1 = __webpack_require__(/*! ./backend */ "./src/backend.ts");
...
function setupIpcHandlers() {
    ...
    electron_1.ipcMain.handle('set-settings', (_event, settings) => {
